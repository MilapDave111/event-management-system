  ...
  return (
    <div className="staff-container">
      <div className="staff-action-grid">
        ...
        {/* Wired up navigation buttons with correct Frontend Route */}
       <button 
          className="staff-action-btn btn-incident"
          onClick={() => navigate('/staff/event-hub', { state: { activeTab: 'assigned' } })} 
        >
          🗂️ View My Tasks
        </button>
        ...
        <button 
          ...
          onClick={() => navigate('/staff/event-hub', { state: { activeTab: 'scan' } })} 
        >
          📷 Scan QR Ticket
        </button>
        
        <button 
          className="staff-action-btn btn-team"
          onClick={() => navigate('/staff/event-hub', { state: { activeTab: 'view-team' } })}
        >
          My Teams
        </button>
        
       <button 
          className="staff-action-btn btn-tasks"
          onClick={() => navigate('/staff/event-hub', { state: { activeTab: 'kanban' } })} 
        >
          📋 My Kanban Board
        </button>
      </div>
