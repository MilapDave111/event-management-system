...
<Route path="/manager/tasks" element={<ProtectedRoute><RoleProtectedRoute allowedRoles={["EVENT_MANAGER", "ORG_ADMIN", "EVENT_STAFF"]}><MainLayout><TaskManagerHub /></MainLayout></RoleProtectedRoute></ProtectedRoute>} />      <Route path="/manager/manage-staff" element={<ProtectedRoute><RoleProtectedRoute allowedRoles={["EVENT_MANAGER", "ORG_ADMIN"]}><MainLayout><ManageStaff /></MainLayout></RoleProtectedRoute></ProtectedRoute>} />
